...
class VGGGray(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1_1 = self.__conv(2, name='conv1_1', in_channels=3, out_channels=64, kernel_size=(3, 3), stride=(1, 1),
                                   groups=1, bias=True)
        self.conv1_1_bn = self.__batch_normalization(2, 'conv1_1/bn', num_features=64, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu1_1 = nn.ReLU(inplace=True)

        self.conv1_2 = self.__conv(2, name='conv1_2', in_channels=64, out_channels=64, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv1_2_bn = self.__batch_normalization(2, 'conv1_2/bn', num_features=64, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu1_2 = nn.ReLU(inplace=True)

        self.conv2_1 = self.__conv(2, name='conv2_1', in_channels=64, out_channels=128, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv2_1_bn = self.__batch_normalization(2, 'conv2_1/bn', num_features=128, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu2_1 = nn.ReLU(inplace=True)

        self.conv2_2 = self.__conv(2, name='conv2_2', in_channels=128, out_channels=128, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv2_2_bn = self.__batch_normalization(2, 'conv2_2/bn', num_features=128, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu2_2 = nn.ReLU(inplace=True)

        self.conv3_1 = self.__conv(2, name='conv3_1', in_channels=128, out_channels=256, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv3_1_bn = self.__batch_normalization(2, 'conv3_1/bn', num_features=256, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu3_1 = nn.ReLU(inplace=True)

        self.conv3_2 = self.__conv(2, name='conv3_2', in_channels=256, out_channels=256, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv3_2_bn = self.__batch_normalization(2, 'conv3_2/bn', num_features=256, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu3_2 = nn.ReLU(inplace=True)

        self.conv3_3 = self.__conv(2, name='conv3_3', in_channels=256, out_channels=256, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv3_3_bn = self.__batch_normalization(2, 'conv3_3/bn', num_features=256, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu3_3 = nn.ReLU(inplace=True)

        self.conv3_4 = self.__conv(2, name='conv3_4', in_channels=256, out_channels=256, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv3_4_bn = self.__batch_normalization(2, 'conv3_4/bn', num_features=256, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu3_4 = nn.ReLU(inplace=True)

        self.conv4_1 = self.__conv(2, name='conv4_1', in_channels=256, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv4_1_bn = self.__batch_normalization(2, 'conv4_1/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu4_1 = nn.ReLU(inplace=True)

        self.conv4_2 = self.__conv(2, name='conv4_2', in_channels=512, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv4_2_bn = self.__batch_normalization(2, 'conv4_2/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu4_2 = nn.ReLU(inplace=True)

        self.conv4_3 = self.__conv(2, name='conv4_3', in_channels=512, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv4_3_bn = self.__batch_normalization(2, 'conv4_3/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu4_3 = nn.ReLU(inplace=True)

        self.conv4_4 = self.__conv(2, name='conv4_4', in_channels=512, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv4_4_bn = self.__batch_normalization(2, 'conv4_4/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu4_4 = nn.ReLU(inplace=True)

        self.conv5_1 = self.__conv(2, name='conv5_1', in_channels=512, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv5_1_bn = self.__batch_normalization(2, 'conv5_1/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu5_1 = nn.ReLU(inplace=True)

        self.conv5_2 = self.__conv(2, name='conv5_2', in_channels=512, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv5_2_bn = self.__batch_normalization(2, 'conv5_2/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu5_2 = nn.ReLU(inplace=True)

        self.conv5_3 = self.__conv(2, name='conv5_3', in_channels=512, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv5_3_bn = self.__batch_normalization(2, 'conv5_3/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
        self.relu5_3 = nn.ReLU(inplace=True)

        self.conv5_4 = self.__conv(2, name='conv5_4', in_channels=512, out_channels=512, kernel_size=(3, 3),
                                   stride=(1, 1), groups=1, bias=True)
        self.conv5_4_bn = self.__batch_normalization(2, 'conv5_4/bn', num_features=512, eps=9.999999747378752e-06,
                                                     momentum=0.0)
